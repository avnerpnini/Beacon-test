        ...
        if (levelsArr.length == 0 && !isRefresh) {
            ...
            if (theQuestion == 999) {
                ...
                //---------------סוג 9 צילום תמונה----------------------------------------
                    ...
                    text += '<div id="takePhotoDiv" style="padding-top: 30px;"><input id="takePhoto" onclick="takePicture()" type="button" data-icon="camera" data-theme="e" data-iconpos="left" value="'+putWord(142)+'"></div>';
